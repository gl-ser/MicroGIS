...
double TBase::AzimuthOfEnd(double B1, double L1, double H1, double B2, double L2, double H2)
{
...
double TBase::ArcTan(double sinF, double cosF)
{
double F;
  try
  {
